<?php
/* Smarty version 3.1.33, created on 2019-04-10 03:18:54
  from 'D:\xamppp\htdocs\jms_mella\themes\jms_mella\modules\jmswishlist\views\templates\front\managewishlist.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5cad98de57b2b7_57314659',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '44ba31f9f09d0b81551c26c766c8680efd5c5dd2' => 
    array (
      0 => 'D:\\xamppp\\htdocs\\jms_mella\\themes\\jms_mella\\modules\\jmswishlist\\views\\templates\\front\\managewishlist.tpl',
      1 => 1554880726,
      2 => 'file',
    ),
  ),
...
function content_5cad98de57b2b7_57314659 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
	...
	<div class="wishlistLinkTop">
		<a href="#" id="hideWishlist" class="button_account btn btn-default" onclick="WishlistVisibility('wishlistLinkTop', 'Wishlist'); return false;" title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Close this wishlist','d'=>'Shop.Theme'),$_smarty_tpl ) );?>
" rel="nofollow"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Close this wishlist','d'=>'Shop.Theme'),$_smarty_tpl ) );?>
		...
		<ul class="clearfix display_list">
			<li>
				<a href="#" id="hideBoughtProducts" class="button_account btn btn-default"  onclick="WishlistVisibility('wlp_bought', 'BoughtProducts'); return false;" title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Hide products','d'=>'Shop.Theme'),$_smarty_tpl ) );?>
"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Hide products','d'=>'Shop.Theme'),$_smarty_tpl ) );?>
				...
				<a href="#" id="showBoughtProducts" class="button_account btn btn-default"  onclick="WishlistVisibility('wlp_bought', 'BoughtProducts'); return false;" title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Show products','d'=>'Shop.Theme'),$_smarty_tpl ) );?>
"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Show products','d'=>'Shop.Theme'),$_smarty_tpl ) );?>
			...
			<li>
				<a href="#" id="hideBoughtProductsInfos" class="button_account btn btn-default" onclick="WishlistVisibility('wlp_bought_infos', 'BoughtProductsInfos'); return false;" title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>"Hide products",'d'=>'Shop.Theme'),$_smarty_tpl ) );?>
"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>"Hide bought products' info",'d'=>'Shop.Theme'),$_smarty_tpl ) );?>
</a>
				<a href="#" id="showBoughtProductsInfos" class="button_account btn btn-default"  onclick="WishlistVisibility('wlp_bought_infos', 'BoughtProductsInfos'); return false;" title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>"Show products",'d'=>'Shop.Theme'),$_smarty_tpl ) );?>
"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>"Show bought products' info",'d'=>'Shop.Theme'),$_smarty_tpl ) );?>
</a>
			</li>
			<?php }?>
		</ul>
		<p class="wishlisturl"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Permalink','d'=>'Shop.Theme'),$_smarty_tpl ) );?>
: <input type="text" value="<?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['link']->value->getModuleLink('jmswishlist','view',array('token'=>$_smarty_tpl->tpl_vars['token_wish']->value)),'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
" style="width:540px;" readonly="readonly" /></p>
		<p class="submit">
			<div id="showSendWishlist">
				<a href="#" class="button_account exclusive btn btn-default" onclick="WishlistVisibility('wl_send', 'SendWishlist'); return false;" title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Send this wishlist','d'=>'Shop.Theme'),$_smarty_tpl ) );?>
...
" />
						...
						<div class="product_infos">
							<p id="s_title" class="product-link" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['name'], ENT_QUOTES, 'UTF-8');?>
...
" size="3"  />
								<br /><br />
								<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Priority','d'=>'Shop.Theme'),$_smarty_tpl ) );?>
:
