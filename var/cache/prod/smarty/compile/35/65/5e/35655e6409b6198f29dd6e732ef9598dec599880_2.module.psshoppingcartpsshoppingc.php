...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5c862cb7070ab3_00159980',
...
function content_5c862cb7070ab3_00159980 (Smarty_Internal_Template $_smarty_tpl) {
...
">
	...
	<a href="#" class="dropdown-toggle cart-icon type2 <?php if ($_smarty_tpl->tpl_vars['cart']->value['products_count'] > 99) {?>center<?php }?> " data-toggle="dropdown">
		<span class="text <?php if ($_smarty_tpl->tpl_vars['cart']->value['products_count'] > 99) {?>hidden<?php }?>"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Cart','d'=>'Shop.Theme.Actions'),$_smarty_tpl ) );?>
</span>
		<span class="ajax_cart_quantity">(<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cart']->value['products_count'], ENT_QUOTES, 'UTF-8');?>
)</span>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
			...
			<div class="cart-button">
				<a id="button_order_cart" class="btn-default btn-effect1" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cart_url']->value, ENT_QUOTES, 'UTF-8');?>
